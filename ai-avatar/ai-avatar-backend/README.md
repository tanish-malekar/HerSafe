...
Create a `.env` file at the root of the repository to add your **Vertex AI SDK API** and **ElevenLabs API Keys**. Refer to `.env.example` for the environment variable names.
